...
# стояние
HERO_IDLE_RIGHT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Idle_2/Idle_{i}_right.png') for i in range(1, 8)]
HERO_IDLE_LEFT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Idle_2/Idle_{i}.png') for i in range(1, 8)]

# бег
HERO_RUN_RIGHT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Run/Run_{i}_right.png') for i in range(1, 7)]
HERO_RUN_LEFT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Run/Run_{i}.png') for i in range(1, 7)]

# пешком (бег для героя)
HERO_WALK_RIGHT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Run/Run_{i}_right.png') for i in range(1, 8)]
HERO_WALK_LEFT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Run/Run_{i}.png') for i in range(1, 8)]

# атака 1
HERO_ATTACK_RIGHT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Attack/Attack_{i}_right.png') for i in range(1, 6)]
HERO_ATTACK_LEFT_IMAGES = [pygame.image.load(f'assets/Knight_horse/Attack/Attack_{i}.png') for i in range(1, 6)]
